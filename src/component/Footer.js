    ...
    render() {
        return (
            ...
            <div className="footer">
                <span className="copright " style={{color: "grey" }}>© 2021 GitHub, Inc.</span>
                <span>Terms</span>
                <span>Privacy</span>
                <span>Secruiry</span>
                <span>status</span>
